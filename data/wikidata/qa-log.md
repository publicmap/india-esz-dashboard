...
Generated 2026-09-14T08:25:52.119Z by `scripts/enrich-wikidata.js`.
...
Cross-referenced against `data/osm/protected-areas.csv` (506 issues flagged).

### Summary

- **Wikidata items with no OSM match**: 306
